 ...
 * <p>
 * "factory method design pattern" implementation for creating items.
...
public class ItemFactory {
     ...
     * <p>
     * Does not check for uniqueness (in subjected vending machine scope); that is instead handled...
    ...
    private void validateName(String name){
        ...
        if (name.length() > 30){ throw new IllegalArgumentException("Name cannot be null or blank"); }
